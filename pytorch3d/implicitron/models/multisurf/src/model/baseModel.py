...
class BaseModel(nn.Module):
    ...
    #     set_trace()
    #     PerspectiveCameras(
    #         focal_length=all_focal_length[None],
    #         principal_point=all_principal_point[None],
    #         R=torch.tensor(all_R, dtype=torch.float)[None],
    #         T=torch.tensor(all_T, dtype=torch.float)[None],
    #     )
        
    #     return img, mask, world_mat, camera_mat, scale_mat, all_imgs, all_masks, all_world_mats, all_camera_mats, all_scale_mats, view_idx, neighbor_list, all_principal_point,all_focal_length, all_R, all_T
