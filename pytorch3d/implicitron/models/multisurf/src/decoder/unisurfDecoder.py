...
class OccupancyNetwork(nn.Module):
    ...
    def gradient(self, p, latent, **kwargs):
    ...
    def forward(self, points, latent, ray_dirs=None, return_occupancy=True, return_feature_vec=False, return_rgb=False, **kwargs):
        """
        Args:
        ...
        if return_rgb:
            ...
            normals = self.gradient(points, latent)
            rgb = self.infer_app(points, normals, input_views, x[..., 1:])
